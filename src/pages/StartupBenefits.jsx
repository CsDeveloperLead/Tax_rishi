...
const StartupBenefits = () => {
  return (
    <div className="w-full px-4 md:px-20 my-10 md:my-10 flex gap-10 flex-col md:flex-row font-montserrat">
      ...
      <h2 className="text-4xl font-bold text-gray-800 mb-4">What are startups?</h2>
      <p className="mb-4">
      ...
      <h3 className="text-2xl font-semibold text-gray-800 mt-6 mb-2">Benefits for Startups</h3>
      <p className="mb-4">If your venture qualifies as a ‘startup’, you can avail of the following benefits:</p>

      <h4 className="text-2xl font-semibold text-gray-800 mt-6 mb-2">1. Financial Benefits</h4>
      <p className="mb-4">
      ...
      <h4 className="text-2xl font-semibold text-gray-800 mt-6 mb-2">2. Registration Benefits</h4>
      <p className="mb-4">
      ...
      <h4 className="text-2xl font-semibold text-gray-800 mt-6 mb-2">3. Income Tax Benefits</h4>
      <p className="mb-4">
      ...
      <div className="bg-gray-100 p-4 rounded-md my-6">
        <h4 className="text-2xl font-semibold text-gray-800 mb-2">Plan Early and Get ahead for next year’s savings</h4>
      ...
      <h4 className="text-2xl font-semibold text-gray-800 mt-6 mb-2">4. Special Benefits</h4>
      <ul className="list-disc list-inside space-y-2 text-gray-700">
      ...
      <h3 className="text-2xl font-semibold text-gray-800 mt-6 mb-2">Register for Startup India with ClearTax</h3>
      <p className="mb-4">
