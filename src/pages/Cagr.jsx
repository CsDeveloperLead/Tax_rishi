        ...
        <div className="w-[75%] flex flex-col gap-10">
          ...
          <div className="mr-10">
            ...
            <p className="text-gray-700 mb-4">
              ...
              <br />
              <br />
              Such a calculator is easily available online, but user-friendliness is important while calculating CAGR returns. Groww’s online CAGR calculator brings you an organized and accurate approach to calculate your business’ CAGR.
            </p>
            ...
            <ul className="w-full list-disc list-inside mb-4">
              <li className="mb-4">Your business is growing with time and whether the profits thus generated is being invested correctly.</li>
              <li className="mb-4">It will enable you to evaluate your investment options. For example, if stock A is not working as well as Stock B based on their respective CAGR indices, you can invest in Stock B instead.</li>
              <li className="mb-4">The relative growth of your organization with respect to the market leaders in your business segment.</li>
            </ul>
            <p className="text-gray-700 mb-4">
            ...
            <div className="overflow-x-auto mb-4">
              <table className="min-w-full table-auto border-collapse">
                <thead>
                  <tr className="">
                    <th className="px-4 py-2 border border-gray-300 w-10">FV</th>
                    <th className="px-4 py-2 border border-gray-300 w-80">Future Value</th>
                  </tr>
                </thead>
                <tbody>
                  <tr>
                    <td className="px-4 py-2 border border-gray-300">PV</td>
                    <td className="px-4 py-2 border border-gray-300 ">Present Value</td>
                  </tr>
                  <tr>
                    <td className="px-4 py-2 border border-gray-300 ">N</td>
                    <td className="px-4 py-2 border border-gray-300 ">Time period in years</td>
                  </tr>
                </tbody>
              </table>
            </div>
            ...
            <ol className="w-full list-decimal list-inside mb-4">
              ...
              <li>Enter the expected value of the investment after a certain period of time.</li>
              <li>Enter the number of years or months for which you wish to use the CAGR calculator .</li>
            </ol>
            ...
            <ul className="w-full list-disc list-inside mb-4">
              ...
              <li>If you are a potential investor, you can also use our service of a mutual fund CAGR calculator. It will help you determine how much you need to invest to maximize returns over a certain period.</li>
              <li>Compare your business’ returns with benchmark options and evaluate the performance.</li>
              <li>Make long-term capital influx plans.</li>
              <li>Avail a globally recognized financial platform and get accurate results.</li>
            </ul>
            <p className="text-gray-700 mb-4">
