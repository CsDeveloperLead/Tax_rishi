    ...
    <div className="mx-4 md:mx-10 my-10 md:my-20 text-[#14598D]">
      <div className="flex flex-col lg:flex-row">
        <div className="w-full md:w-[75%] flex flex-col gap-10">
          <div className="border h-aut0 md:h-[640px] flex flex-col md:flex-row  bg-white p-6 gap-10  rounded-lg shadow-lg">
          ...
          <div className="w-full mr-10">
            ...
            <p className="mb-4">
              <span className="">Step 1 :</span> Enter your basic salary and HRA you get as per your salary slip
            </p>
            <p className="mb-4">
              <span className="">Step 2 :</span> Enter the actual rent paid and specify whether you live in a metro city or not from the drop-down.
            </p>
            <p className="mb-4">
            ...
            <p className="mb-4">
              <span className="">Step 1 :</span> Keep all essential details about your employment history handy.
            </p>
            <p className="mb-4">
              <span className="">Step 2 :</span> Enter the basic pay + dearness allowance value and the gratuity value will be reflected within seconds.
            </p>
            <h2 className="text-2xl font-semibold mt-8 mb-4">
