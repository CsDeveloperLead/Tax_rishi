          ...
          <div className="mr-10">
            ...
            <div className="overflow-x-auto mb-4">
              <table className="min-w-full table-auto border-collapse text-main">
                <thead>
                  <tr className="">
                    <th className="px-4 py-2 border border-gray-300 w-10" colSpan={2}>Fixed Deposit</th>
                  </tr>
                </thead>
                <tbody>
                  <tr>
                    <td className="px-4 py-2 border border-gray-300">Types of Fixed Deposit</td>
                    <td className="px-4 py-2 border border-gray-300 ">Overdraft Against FD</td>
                  </tr>
                  <tr>
                    <td className="px-4 py-2 border border-gray-300 ">Monthly Interest on 1 Lakh Fixed Deposit</td>
                    <td className="px-4 py-2 border border-gray-300 ">Non Callable Fixed Deposits</td>
                  </tr>
                  <tr>
                    <td className="px-4 py-2 border border-gray-300">Fixed Deposit(FD) Sweep-in</td>
                    <td className="px-4 py-2 border border-gray-300 ">Auto Renewal of Fixed Deposit</td>
                  </tr>
                  <tr>
                    <td className="px-4 py-2 border border-gray-300">Flexi Fixed Deposit</td>
                    <td className="px-4 py-2 border border-gray-300 ">Senior Citizen FD Interest Rates</td>
                  </tr>
                  <tr>
                    <td className="px-4 py-2 border border-gray-300">Fixed Deposit Double Scheme</td>
                    <td className="px-4 py-2 border border-gray-300 ">Monthly Interest Payout Fixed Deposit(FD)</td>
                  </tr>
                </tbody>
              </table>
            </div>
