          ...
          <div className="mr-10">
            ...
            <div className="overflow-x-auto">
              <table className="min-w-full table-auto border-collapse">
                <thead>
                  <tr className="">
                    <th className="px-4 py-2 border border-gray-300 text-center w-32">Month</th>
                    <th className="px-4 py-2 border border-gray-300 text-center w-60">Balance at Begin</th>
                    <th className="px-4 py-2 border border-gray-300 text-center w-60">Withdrawal</th>
                    <th className="px-4 py-2 border border-gray-300 text-center w-60">Interest Earned</th>
                  </tr>
                </thead>
                <tbody>
                  {/* Row 1 */}
                  <tr>
                    ...
                    <td className="px-4 py-2 border border-gray-300 text-center ">Rs. 10000</td>
                    <td className="px-4 py-2 border border-gray-300 text-center ">Rs. 10000</td>
                    <td className="px-4 py-2 border border-gray-300 text-center ">Rs. 10000</td>
                  </tr>
                  {/* Row 2 */}
                  ...
                  <tr>
                    <td className="px-4 py-2 border border-gray-300 text-center ">7</td>
                    <td className="px-4 py-2 border border-gray-300 text-center ">Rs. 10000</td>
                    <td className="px-4 py-2 border border-gray-300 text-center ">Rs. 10000</td>
                    <td className="px-4 py-2 border border-gray-300 text-center ">Rs. 10000</td>
                  </tr>
                  <tr>
                    <td className="px-4 py-2 border border-gray-300 text-center ">8</td>
                    <td className="px-4 py-2 border border-gray-300 text-center ">Rs. 10000</td>
                    <td className="px-4 py-2 border border-gray-300 text-center ">Rs. 10000</td>
                    <td className="px-4 py-2 border border-gray-300 text-center ">Rs. 10000</td>
                  </tr>
                  <tr>
                    <td className="px-4 py-2 border border-gray-300 text-center ">9</td>
                    <td className="px-4 py-2 border border-gray-300 text-center ">Rs. 10000</td>
                    <td className="px-4 py-2 border border-gray-300 text-center ">Rs. 10000</td>
                    <td className="px-4 py-2 border border-gray-300 text-center ">Rs. 10000</td>
                  </tr>
                  <tr>
                    <td className="px-4 py-2 border border-gray-300 text-center ">10</td>
                    <td className="px-4 py-2 border border-gray-300 text-center ">Rs. 10000</td>
                    <td className="px-4 py-2 border border-gray-300 text-center ">Rs. 10000</td>
                    <td className="px-4 py-2 border border-gray-300 text-center ">Rs. 10000</td>
                  </tr>
            ...
            <ul className="w-full list-disc list-inside">
              <li>You will find three columns namely tenure, expected return and amount invested. Fill in the values as per your investment plan.</li>
              <li>Enter values and calculate to find a similar SWP returns chart as mentioned above.</li>
            </ul>
            ...
            <ul className="w-full list-disc list-inside">
              ...
              <li>This SWP return calculator does not require any expertise to operate. Users need to just put variables in proper space and output is ready in no time.</li>
            </ul>
