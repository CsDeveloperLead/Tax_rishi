          ...
          <div className="mr-10">
            ...
            <div className="overflow-x-auto mb-4">
              <table className="min-w-full table-auto border-collapse">
                <tbody>
                  <tr>
                    <td className="px-4 py-2 border border-gray-300 w-20">SI</td>
                    <td className="px-4 py-2 border border-gray-300 w-80">Simple Interest</td>
                  </tr>
                  <tr>
                    <td className="px-4 py-2 border border-gray-300 ">R</td>
                    <td className="px-4 py-2 border border-gray-300 ">Rate of interest</td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    ...
                    <td className="px-4 py-2 border border-gray-300 ">Principle</td>
                  </tr>
                </tbody>
              </table>
            </div>
            ...
            <ul className="w-full list-disc list-inside">
              <li className="text-gray-900 mb-2"><span className="text-black font-semibold">When one has borrowed money :</span> To repay extra payment of interest along with the borrowed amount. The formula for simple interest can help to calculate the borrowing cost as interest</li>
              <li className="text-gray-900 mb-2"><span className="text-black font-semibold">When someone lends money :</span> If someone has given money to someone to earn interest income in exchange. By using simple interest formula, one can easily get extra income figure as the interest</li>
              <li className="text-gray-900 mb-2"><span className="text-black font-semibold">When someone has invested money :</span> if someone has invested their surplus money in deposits such as FD, RD or savings schemes like SSY, PPF or others can also calculate the interest Income with a simple Interest Calculator.</li>
            </ul>
            <h2 className="text-2xl font-semibold text-gray-900 mt-8 mb-4">
              How to Calculate Simple Interest using Calculator?
            </h2>
            <ul className="w-full list-disc list-inside">
              <li>This simple interest calculator offers you output by calculating both principals as well as interest.</li>
              <li>Although it is easy to calculate simple interest for shorter tenors but for long consecutive years, a manual mechanism increases the chances of mistakes. So, use an online simple interest calculator for accurate calculation.</li>
              <li>Quick and easy way to gain insight into interest as well as the increase in the invested capital.</li>
            </ul>
            <h2 className="text-2xl font-semibold text-gray-900 mt-8 mb-4">
            ...
            <ul className="w-full list-disc list-inside">
              <li>SI is computed irrespective of any unit. Be it dollar, euro or any other currency, it calculates effectively.</li>
              <li>Users who intend to save time on calculating interest rates with changing years can save their time with its judicious use.</li>
              <li>Numerous variables are available to help you gauge your total investment. So, knowing about the total return and maturity time helps you to take viable decisions.</li>
              <li>A simple interest loan calculator helps in determining the current value of money.</li>
            </ul>
          </div>
        </div>
        <div className="w-[25%]">
              ...
              <ul>
                {[
                  ...
                  },
                  {
                    ...
                    description:
                      "Calculate returns for your Employee’s Provident Fund (EPF)",
                    link: "/epf",
                  },
                  {
                    title: "FD Calculator",
                  ...
                  },
                  {
                    ...
                    description:
                      "Estimate the gratuity amount based on your tenure and salary",
                    link: "/gratuity",
                  },
                  {
                    title: "HRA Calculator",
                    description:
                      "Calculate House Rent Allowance (HRA) exemption based on your rent and salary",
                    link: "/hra",
                  },
                  {
                    title: "NPS Calculator",
                    description:
                      "Estimate the final amount and pension from your National Pension Scheme (NPS) contributions",
                    link: "/nps",
                  },
                  {
                    title: "Simple Interest Calculator",
                    description:
                      "Calculate simple interest on your principal investment",
                    link: "/simple-interest",
                  },
                  {
                    title: "Compound Interest Calculator",
                    description:
                      "Calculate compound interest and growth on your investment",
                  ...
                  },
                  {
                    ...
                    description:
                      "Calculate Goods and Services Tax (GST) on your transactions",
                    link: "/gst",
                  },
