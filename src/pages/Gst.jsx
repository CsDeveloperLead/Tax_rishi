...
function GSTCalculator() {
  ...
  const calculateGST = () => {
    ...
    const postGstAmount = gstType === "excluding" ? amount + gstAmount : amount;
          ...
          <div className="w-[75%] flex flex-col gap-10">
            ...
            <div className="mr-10">
              ...
              <p className="text-gray-700 mb-4">
                ...
                goods and services purchased within its jurisdiction. It is a
              ...
              <p className="text-gray-700 mb-4">
                ...
                they purchase and all the services they avail. As such, it is
                paramount that one understands how to compute GST accurately.
              ...
              <p className="text-gray-700 mb-4">
                ...
                an Indian GST calculator can come to your aid.
              </p>
              <ul className="w-full list-disc list-inside">
                <li className="mb-2">
                  GST tax calculator provides you with an accurate estimate of
                ...
                <li className="mb-2">
                  It eliminates the chances of any fraudulent activities if you
