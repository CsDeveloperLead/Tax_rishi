          ...
          <div className="mr-10 w-full">
            ...
            <div className="overflow-x-auto">
              <table className="min-w-full table-auto border-collapse">
                <thead>
                  <tr className="">
                    <th className="px-1  md:px-4 py-2 border border-gray-300 md:w-82">Name of the stock</th>
                    <th className="px-1  md:px-4 py-2 border border-gray-300 md:w-40">Risk</th>
                    <th className="px-1  md:px-4 py-2 border border-gray-300 md:w-40">1-Year Return</th>
                    <th className="px-1  md:px-4 py-2 border border-gray-300 md:w-40">3-Year Return</th>
                  </tr>
                </thead>
                <tbody>
                  <tr>
                    <td className="px-1 md:px-4 py-2 border border-gray-300">Aditya Birla Sunlife Frontline Equity Fund</td>
                    <td className="px-1 md:px-4 py-2 border border-gray-300 ">Moderate</td>
                    <td className="px-1 md:px-4 py-2 border border-gray-300 ">10 %</td>
                    <td className="px-1 md:px-4 py-2 border border-gray-300 ">10 %</td>
                  </tr>
                  <tr>
                    <td className="px-1 md:px-4 py-2 border border-gray-300 ">HDFC Mid-cap Opportunities Fund</td>
                    <td className="px-1 md:px-4 py-2 border border-gray-300 ">High</td>
                    <td className="px-1 md:px-4 py-2 border border-gray-300 ">10 %</td>
                    <td className="px-1 md:px-4 py-2 border border-gray-300 ">10 %</td>
                  </tr>
                  <tr>
                    <td className="px-1 md:px-4 py-2 border border-gray-300">ICICI Pru Focused Bluechip Equity Fund</td>
                    <td className="px-1 md:px-4 py-2 border border-gray-300 ">Moderate</td>
                    <td className="px-1 md:px-4 py-2 border border-gray-300 ">10 %</td>
                    <td className="px-1 md:px-4 py-2 border border-gray-300 ">10 %</td>
                  </tr>
            ...
            <div className="overflow-x-auto my-6">
              <table className="min-w-full table-auto border-collapse">
                ...
                <tbody>
                  <tr>
                    <td className="px-1 md:px-4 py-2 border border-gray-300">Aditya Birla Sun Life Active Debt Multi-manager FoF Scheme</td>
                    <td className="px-1 md:px-4 py-2 border border-gray-300 ">Low</td>
                    <td className="px-1 md:px-4 py-2 border border-gray-300 ">10 %</td>
                    <td className="px-1 md:px-4 py-2 border border-gray-300 ">10 %</td>
                  </tr>
                  <tr>
                    <td className="px-1 md:px-4 py-2 border border-gray-300 ">Axis Short Term –Direct Plan</td>
                    <td className="px-1 md:px-4 py-2 border border-gray-300 ">Moderate</td>
                    <td className="px-1 md:px-4 py-2 border border-gray-300 ">10 %</td>
                    <td className="px-1 md:px-4 py-2 border border-gray-300 ">10 %</td>
                  </tr>
                  <tr>
                    <td className="px-1 md:px-4 py-2 border border-gray-300">Canara Robeco Income- Reg</td>
                    <td className="px-1 md:px-4 py-2 border border-gray-300 ">High</td>
                    <td className="px-1 md:px-4 py-2 border border-gray-300 ">10 %</td>
                    <td className="px-1 md:px-4 py-2 border border-gray-300 ">10 %</td>
                  </tr>
            ...
            <div className="overflow-x-auto ">
              <table className="min-w-full table-auto border-collapse">
                ...
                <tbody>
                  <tr>
                    <td className="px-1 md:px-4 py-2 border border-gray-300">Indiabulls Savings Income Direct-G</td>
                    <td className="px-1 md:px-4 py-2 border border-gray-300 ">Low</td>
                    <td className="px-1 md:px-4 py-2 border border-gray-300 ">10 %</td>
                    <td className="px-1 md:px-4 py-2 border border-gray-300 ">10 %</td>
                  </tr>
                  <tr>
                    <td className="px-1 md:px-4 py-2 border border-gray-300 ">Mirae Asset Hybrid Equity Direct- G</td>
                    <td className="px-1 md:px-4 py-2 border border-gray-300 ">High</td>
                    <td className="px-1 md:px-4 py-2 border border-gray-300 ">10 %</td>
                    <td className="px-1 md:px-4 py-2 border border-gray-300 ">10 %</td>
                  </tr>
                  <tr>
                    <td className="px-1 md:px-4 py-2 border border-gray-300">ICICI Pru Equity & Debt Direct-G</td>
                    <td className="px-1 md:px-4 py-2 border border-gray-300 ">High</td>
                    <td className="px-1 md:px-4 py-2 border border-gray-300 ">10 %</td>
                    <td className="px-1 md:px-4 py-2 border border-gray-300 ">10 %</td>
                  </tr>
