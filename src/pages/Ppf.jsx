          ...
          <div className="mr-10">
            ...
            <div className="overflow-x-auto mb-4">
              <table className="min-w-full table-auto border-collapse">
                <thead>
                  <tr className="">
                    <th className="px-4 py-2 border border-gray-300 w-10">I</th>
                    <th className="px-4 py-2 border border-gray-300 w-80">Rate of interest</th>
                  </tr>
                </thead>
                <tbody>
                  <tr>
                    <td className="px-4 py-2 border border-gray-300">F</td>
                    <td className="px-4 py-2 border border-gray-300 ">Maturity of PPF</td>
                  </tr>
                  <tr>
                    <td className="px-4 py-2 border border-gray-300 ">N</td>
                    <td className="px-4 py-2 border border-gray-300 ">Total number of years</td>
                  </tr>
                  <tr>
                    <td className="px-4 py-2 border border-gray-300">P</td>
                    <td className="px-4 py-2 border border-gray-300 ">Annual instalments</td>
                  </tr>
                </tbody>
              </table>
            </div>
            ...
            <div className="overflow-x-auto mb-4">
              <table className="min-w-full table-auto border-collapse">
                <thead>
                  <tr className="">
                    <th className="px-4 py-2 border border-gray-300 w-20">Year</th>
                    <th className="px-4 py-2 border border-gray-300 w-60">Opening amount</th>
                    <th className="px-4 py-2 border border-gray-300 w-40">Deposit</th>
                    <th className="px-4 py-2 border border-gray-300 w-60">Rate of interest</th>
                    <th className="px-4 py-2 border border-gray-300 w-60">Closing amount</th>
                    <th className="px-4 py-2 border border-gray-300 w-40">Loan</th>
                    <th className="px-4 py-2 border border-gray-300 w-60">Amount withdrawn</th>
                  </tr>
                </thead>
                <tbody>
                  <tr>
                    <td className="px-4 py-2 border border-gray-300">1</td>
                    <td className="px-4 py-2 border border-gray-300 ">Rs. 189292</td>
                    <td className="px-4 py-2 border border-gray-300 ">Rs. 189292</td>
                    <td className="px-4 py-2 border border-gray-300 ">Rs. 189292</td>
                    <td className="px-4 py-2 border border-gray-300 ">Rs. 189292</td>
                    <td className="px-4 py-2 border border-gray-300 ">Rs. 189292</td>
