      ...
      <div className="flex flex-col lg:flex-row">
        <div className="w-[75%] flex flex-col gap-10">
          ...
          <div className="mr-10">
            ...
            <p className="text-gray-700 mb-4">
              Groww uses a proprietary formula that is benchmarked with other similar offerings. The formula used by our online gratuity calculator is:
            </p>
            <p className="text-gray-700 mb-4">
              G = n*b*15/26
            </p>
              ...
              <table className="min-w-full table-auto border-collapse">
                <tbody>
                  <tr className="">
                    ...
                    <td className="px-4 py-2 border border-gray-300">The number of years you have worked in the concerned organisation</td>
                  </tr>
                  <tr>
                    <td className="px-4 py-2 border border-gray-300">B/b</td>
                    <td className="px-4 py-2 border border-gray-300 ">Last drawn basic salary plus Dearness Allowance (DA)</td>
                  </tr>
                  <tr>
                    <td className="px-4 py-2 border border-gray-300 ">G</td>
                    <td className="px-4 py-2 border border-gray-300 ">Gratuity amount you are eligible for</td>
                  </tr>
                </tbody>
              </table>
            </div>
            ...
            <ul className="w-full list-disc list-inside mb-4">
              <li className="mb-4">Your gratuity cannot exceed Rs. 10 Lakh in its entirety. Any amount beyond this upper limit is called ex gratia payment.</li>
              <li className="mb-4">Also, if you have worked for, say 17 years and 6 months, the figure will be rounded off to the nearest single digit or 18 years.</li>
            </ul>
            <h2 className="text-2xl font-semibold text-gray-900 mt-8 mb-4">
              How can a Gratuity Calculator Help You?
            </h2>
            <p className="text-gray-700 mb-4">
              Under the Payment of Gratuity Act of 1972, you are eligible to receive the gratuity amount provided –
            </p>
            <ul className="w-full list-disc list-inside mb-4">
