        ...
        <div className="w-full md:w-[75%] flex flex-col gap-10">
              ...
              <div className="my-4">
                <div className="flex justify-between items-center mb-2">
                  ...
                  <input
                    ...
                    className="text-main font-bold bg-[#CDD4F1] w-[120px] px-2 py-1 text-right"
                  />
                </div>
                <input
                  type="range"
              ...
              <div className="my-4">
                <div className="flex justify-between items-center mb-2">
                  ...
                  <input
                    ...
                    className="text-main font-bold bg-[#CDD4F1] w-[80px] px-2 py-1 text-right"
                  />
                </div>
                <input
                  type="range"
          ...
          <div className="w-full mr-10">
            ...
            <p className="text-gray-700 mb-4">
              ...
              jobs with little security, they need a National Pension Scheme
            ...
            <ol className="w-full list-decimal list-inside mb-4">
              <li className="mb-4">
                It provides you with the amount of money which you are entitled
                to in the future. The pension amount is an investment and not a
                liability. Using an NPS calculator online is essential to
                determine the total corpus.
              </li>
              <li className="mb-4">
                Under the existing legislature, no individual can withdraw the
                entire amount of post-retirement. Besides, 40% worth of the
                total sum must be invested in annuities. Furthermore, the
                remaining 60% is subjected to taxation too. All these figures
                will be disclosed in detail once you start using our NPS scheme
                calculator .
              </li>
              <li className="mb-4">
                The calculator never errs. If you have ever tried to manually
                calculate the pension amounts, you will understand how tough it
                is. Thankfully, our NPS calculator in India will automate the
                entire process.
              </li>
              <li className="mb-4">
                Lastly, you can now determine the taxation regime on pension
                funds, the total amount you will have every month-end and
            ...
            <ul className="w-full list-disc list-inside mb-4">
              ...
              <li className="mb-4">
                You will now know how much your pension amount will be. That
                will aid you in future planning.{" "}
              </li>
