      ...
      <div className="flex flex-col lg:flex-row">
        <div className="w-full md:w-[75%] flex flex-col gap-10">
          <div className="border h-auto md:h-[620px] flex flex-col md:flex-row bg-white p-6 gap-10  rounded-lg shadow-lg">
            ...
            <div className="w-full mt-6 md:w-[30%] flex justify-center">
          ...
          <div className="w-full mr-10">
            ...
            <ul className="w-full list-disc list-inside">
              <li className="mb-2">It helps you determine an accurate figure and percentage of returns over a certain time frame.</li>
              <li className="mb-2">A reliable calculator helps you identify how much investment you might need over a time frame. The required corpus of funds can then be arranged with convenience.</li>
              <li className="mb-2">Groww offers you a customizable compound interest rate calculator which helps you assign values based on your requirements.</li>
            ...
            <div className="overflow-x-auto mb-4">
              <table className="min-w-full table-auto border-collapse">
                <tbody>
                  <tr>
                    <td className="px-4 py-2 border border-gray-300 w-20">P</td>
                    <td className="px-4 py-2 border border-gray-300 w-80">Principal Amount</td>
                  </tr>
                  <tr>
                    <td className="px-4 py-2 border border-gray-300 ">A</td>
                    <td className="px-4 py-2 border border-gray-300 ">Compound interest</td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    ...
                    <td className="px-4 py-2 border border-gray-300 ">Number of times interest compounds in a year</td>
                  </tr>
                  <tr>
                    <td className="px-4 py-2 border border-gray-300">T/t</td>
                    <td className="px-4 py-2 border border-gray-300 ">Number of years</td>
                  </tr>
                </tbody>
              </table>
            </div>
