...
import img14 from '../../assets/gstrishi14.png'
        ...
        <div className='w-full px-4 md:px-20 my-10 md:my-10 flex gap-10 flex-col md:flex-row font-montserrat text-[#14598D]'>
            <div className='w-[80%] flex flex-col gap-4'>
                ...
                <table className="table-auto w-full border-collapse border border-gray-300">
                    ...
                    <tbody>
                        ...
                        <tr className="bg-white">
                            ...
                            <td className="border border-gray-300 p-4">IRN- Invoice Reference Number</td>
                            <td className="border border-gray-300 p-4">Max length: 64 Sample is ‘a5c12dca8 0e7433217…ba4013 750f2046f229’</td>
                            <td className="border border-gray-300 p-4">At the time of the registration request, this field is left empty by the supplier. Later on, a unique number will be generated by GSTN after uploading the e-invoice on the GSTN portal. An acknowledgement will be sent back to the supplier after the successful acceptance of the e-invoice by the portal. IRN should then be displayed on the e-invoice before use.</td>
                        </tr>
                        <tr className="bg-white">
                            <td className="border border-gray-300 p-4">19</td>
                            <td className="border border-gray-300 p-4">ShippingTo_GSTIN</td>
                            <td className="border border-gray-300 p-4">Max length: 15</td>
                            <td className="border border-gray-300 p-4">GSTIN of the buyer himself or the person to whom the particular item is being delivered to</td>
                        </tr>
                        <tr className="bg-white">
                            <td className="border border-gray-300 p-4">20</td>
                            <td className="border border-gray-300 p-4">Shipping To_State, Pincode and State code</td>
                            <td className="border border-gray-300 p-4">Max length: 100 for state, 6 digit pincode and enumerated list for code</td>
                            <td className="border border-gray-300 p-4">State pertaining to the place to which the goods and services invoiced were or are delivered</td>
                        </tr>
                        <tr className="bg-white">
                            <td className="border border-gray-300 p-4">21</td>
                            <td className="border border-gray-300 p-4">Dispatch From_ Name, Address, Place and Pincode</td>
                            <td className="border border-gray-300 p-4">Max length: 100 each and 6 digit for pincode</td>
                            <td className="border border-gray-300 p-4">Entity’s details (name, and city/town/village) from where goods are dispatched</td>
                        </tr>
                        <tr className="bg-white">
                            <td className="border border-gray-300 p-4">22</td>
                            <td className="border border-gray-300 p-4">Is_Service</td>
                            <td className="border border-gray-300 p-4">String (Length: 1) by selecting Y/N</td>
                            <td className="border border-gray-300 p-4">Whether or not supply of service must be mentioned</td>
                        </tr>
                        <tr className="bg-white">
                            <td className="border border-gray-300 p-4">23</td>
                            <td className="border border-gray-300 p-4">Supply Type Code</td>
                            <td className="border border-gray-300 p-4">Enumerated list of codes Sample values can be either of B2B/B2C/ SEZWP/S EZWOP/E XP WP/EXP WOP/DE XP</td>
                            <td className="border border-gray-300 p-4">Code will be used to identify types of supply such as business to business, business to consumer, supply to SEZ/exports with or without payment, and deemed export.</td>
                        </tr>
                        <tr className="bg-white">
                            <td className="border border-gray-300 p-4">24</td>
                            <td className="border border-gray-300 p-4">Item Description</td>
                            <td className="border border-gray-300 p-4">Max length: 300 The sample value is ‘Mobile’ The schema document refers to this as the ‘identification scheme identifier of the Item classification identifier’</td>
                            <td className="border border-gray-300 p-4">Simply put, the relevant description is generally used for the item in the trade. However, more clarity is needed on how it needs to be described for every two or more items belonging to the same HSN code.</td>
                        </tr>
                        <tr className="bg-white">
                            <td className="border border-gray-300 p-4">25</td>
                            <td className="border border-gray-300 p-4">HSN Code</td>
                            <td className="border border-gray-300 p-4">Max length: 8</td>
                            <td className="border border-gray-300 p-4">The applicable HSN code for particular goods/service must be entered</td>
                        </tr>
                        <tr className="bg-white">
                            <td className="border border-gray-300 p-4">26</td>
                            <td className="border border-gray-300 p-4">Item_Price</td>
                            <td className="border border-gray-300 p-4">Decimal (12,3) Sample value is ‘50’</td>
                            <td className="border border-gray-300 p-4">The unit price, exclusive of GST, before subtracting item price discount, can not be negative</td>
                        </tr>
                        <tr className="bg-white">
                            <td className="border border-gray-300 p-4">27</td>
                            <td className="border border-gray-300 p-4">Assessable Value</td>
                            <td className="border border-gray-300 p-4">Decimal (13,2) Sample value is ‘5000’</td>
                            <td className="border border-gray-300 p-4">The price of an item, exclusive of GST, after subtracting the item price discount. Hence, gross price (-) discount = net price item, if any cash discount is provided at the time of sale</td>
                        </tr>
                        <tr className="bg-white">
                            <td className="border border-gray-300 p-4">28</td>
                            <td className="border border-gray-300 p-4">GST Rate</td>
                            <td className="border border-gray-300 p-4">Decimal (3,2) Sample value is ‘5’</td>
                            <td className="border border-gray-300 p-4">The GST rate represented as a percentage that is applicable to the item being invoiced</td>
                        </tr>
                        <tr className="bg-white">
                            <td className="border border-gray-300 p-4">29</td>
                            <td className="border border-gray-300 p-4">IGST Value, CGST Value and SGST Value Separately</td>
                            <td className="border border-gray-300 p-4">Decimal (11,2) Sample value is ‘650.00’</td>
                            <td className="border border-gray-300 p-4">For each individual item, IGST, CGST and SGST amounts have to be specified</td>
                        </tr>
                        <tr className="bg-white">
                            <td className="border border-gray-300 p-4">30</td>
                            <td className="border border-gray-300 p-4">Total Invoice Value</td>
                            <td className="border border-gray-300 p-4">Decimal (11,2)</td>
                            <td className="border border-gray-300 p-4">The total amount of the Invoice with GST. Must be rounded to a maximum of 2 decimals</td>
                        </tr>
                    </tbody>
                </table>
                <h2 className="text-4xl leading-[50px] font-semibold">Format of sample e-invoice</h2>
                <p className="text-base leading-8">The e-invoice format notified is as follows: </p>
                <img src={img14} alt="image" className='h-[60%] mx-auto' />
                <h2 className="text-4xl leading-[50px] font-semibold">How does Clear e-Invoicing help?</h2>
                <p className="text-base leading-8">
                ...
                <ul className='list-inside list-disc pl-6'>
                    <li className='mt-2'>Seamless generation of 5,000 e-invoices per minute</li>
                    <li className='mt-2'>Integration with a high-fidelity solution with 99.99% uptime</li>
                    <li className='mt-2'>100+ data validations to ensure an error-free, smooth e-invoicing experience</li>
                    <li className='mt-2'>Auto-retry of failed EWBs (with distance error) to improve the success rate of EWB generation</li>
                    <li className='mt-2'>Automatic generation of the e-way bill after IRN generation without any ingestion of data</li>
                    <li className='mt-2'>Faster loading of ‘e-invoices’ and ‘e-way bills’ on the screen for as many as 1 lakh documents</li>
                    <li className='mt-2'>Reconciliation vis-a-vis e-way bill and GSTR-1 data</li>
                    <li className='mt-2'>Insightful reports, customised print templates for e-invoices, and data archiving</li>
                </ul>
            </div>
            <div className="w-[25%]">
