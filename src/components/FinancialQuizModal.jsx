  ...
  return (
    ...
    >
      <div
        ...
        } h-full md:h-full p-1 rounded-2xl mt-0 md:mt-0 relative`}
      >
        {/* Left Section */}
        <div
        ...
        {/* Right Section */}
        <div
          className="w-full md:w-1/2 h-full transform flex flex-col items-center relative box2 overflow-y-auto"
          style={{ transition: "transform 1s ease" }}
        >
          {/* Progress Bar */}
            ...
            currentStep <= 5 ? (
              <>
                {currentStep <= 4 ? (
                  ...
                  <div className="flex flex-col items-center justify-center w-full h-full font-montserrat px-4 mt-24 md:mt-0 ">
